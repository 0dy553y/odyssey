...
task add_pull_up_music_production_and_squat: :environment do
    ...
    ActiveRecord::Base.transaction do
        challenge_your_desc = %(
  In this challenge, Ryan Hurst (Head Coach at GMB Fitness) will walk you through building a solid pull-up, starting with the foundations. With just 3 simple exercises, you’ll quickly and safely build your pulling strength.
).squish
  ...
  There's plenty of time at home so there's plenty of time for making music, but sometimes the well of inspiration runs dry. That's why MusicTech is bringing you a 30 day challenge to help you stay creative while you stay at home. Try approaches old and new, and most importantly have fun doing it.
).squish
        ...
        challenge_squat_desc = %(
This 30-day squat challenge starts with foundational exercises and adds targeted challenges.
This method improves postural alignment, core strength, and functional stability so that it's easier to maintain your hard-earned results.
).squish
