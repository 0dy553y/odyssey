...
task update_maps_for_challenges: :environment do
  ...
  Challenge.find_by(name: 'Portrait Drawing').map.update!(land: 2, building_block: 0, background: 3, environment_object: 2)
  ...
  Challenge.find_by(name: 'Starting the Year Right').map.update!(land: 0, building_block: 0, background: 2, environment_object: 2)
  ...
  Challenge.find_by(name: 'Your First Pull-Up').map.update!(land: 6, building_block: 0, background: 1, environment_object: 0)
